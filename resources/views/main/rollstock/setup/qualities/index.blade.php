    ...
    <div class="col-md-12">
      <div class="panel panel-default">
        <div class="panel-heading">
          <h3 class="panel-title">List Kualitas Kertas</h3>
        </div>
        <div class="panel-body">
          <div class="row">
            <div class="col-md-12">
              <a href="{{ route('qualities.create') }}" class="btn btn-success">
                Tambah
              </a>
            </div>
          </div>
...
<script>
  ...
  function reload_datatable(){
    ...
    $('#table-dataTable').DataTable({
      ...
      pageLength: 100,
      ajax: {
        'url' : '{!! route('qualities.ajax.getQualityListDatatable') !!}',
        'type': 'POST',
      ...
      columnDefs: [
        ...
        { title: "Kualitas", className: "text-center w45", "targets": [ 1 ] },
      ...
      buttons: [
        // EXCEL BUTTON
        {
          extend : 'excelHtml5',
          text : 'Send to Excel',
          title: 'qualities_'+getCurrentDateTime(),
          footer: true,
          exportOptions: {
            modifier: {
                search: 'applied',
