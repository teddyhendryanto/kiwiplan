    ...
    <div class="col-md-12">
      <div class="panel panel-default">
        <div class="panel-heading">
          <h3 class="panel-title">List Gramatur Kertas</h3>
        </div>
        <div class="panel-body">
          <div class="row">
            <div class="col-md-12">
              <a href="{{ route('gramatures.create') }}" class="btn btn-success">
                Tambah
              </a>
            </div>
          </div>
...
<script>
  ...
  function reload_datatable(){
    ...
    $('#table-dataTable').DataTable({
      ...
      pageLength: 100,
      ajax: {
        'url' : '{!! route('gramatures.ajax.getGramaturListDatatable') !!}',
        'type': 'POST',
        'data': {_token : '{{ csrf_token() }}'},
      },
      columns: [
        { data: 'rownum', name: 'rownum'},
        { data: 'gramatur', name: 'gramatur'},
        { data: 'action', name: 'action', orderable: false, searchable: false}
      ],
      columnDefs: [
        { title: "#", className: "text-center w10", "targets": [ 0 ] },
        { title: "Gramatur", className: "text-center w45", "targets": [ 1 ] },
      ...
      buttons: [
        // EXCEL BUTTON
        {
          extend : 'excelHtml5',
          text : 'Send to Excel',
          title: 'gramatures_'+getCurrentDateTime(),
          footer: true,
          exportOptions: {
            modifier: {
                search: 'applied',
