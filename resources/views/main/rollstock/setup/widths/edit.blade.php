...
@section('breadcrumb')
  <div id="#breadcrumb">
    <ol class="breadcrumb">
      ...
      <li><a href="{{ route('widths.edit', Request::segment(4)) }}" class="active">Edit Lebar</a></li>
    </ol>
  </div>
@endsection
    ...
    <div class="col-md-12">
      <div id="panel-info" class="panel panel-default">
        ...
        <div id="panel-body" class="panel-body">
          <div class="row">
            <div class="col-md-12">
              <form id="form" class="form" role="form" method="POST" action="{{ route('widths.update', $data->id) }}">
                {{ csrf_field() }}
                @if(isset($data))
                ...
                <div class="row">
                  <div class="col-md-4">
                    ...
                    <div class="form-group">
                      <input type="text" id="width" name="width" class="form-control text-uppercase" required value="{{ $data->width }}" autofocus>
                    </div>
                  </div>
                </div>
                <div class="row">
