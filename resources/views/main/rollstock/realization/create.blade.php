...
@section('title', 'Realisasi P.O Baru')
...
@section('breadcrumb')
  <div id="#breadcrumb">
    <ol class="breadcrumb">
      ...
      <li><a href="{{ route('purchase_order_realizations.create') }}" class="active">Buat Baru</a></li>
    </ol>
  </div>
@endsection
    ...
    <div class="col-md-12">
      <div id="panel-info" class="panel panel-default">
        ...
        <div id="panel-body" class="panel-body">
          <div class="row">
            <div class="col-md-12">
              <form id="form" class="form" role="form" method="POST" action="{{ route('purchase_order_realizations.store') }}">
                {{ csrf_field() }}
                @if(isset($data))
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        ...
                        <div class="form-group">
                          <input type="text" name="total_qty" class="form-control" value="{{ old('total_qty') }}" readonly>
                        </div>
                      </div>
                      <div class="col-md-4">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        ...
                        <div class="form-group">
                          <input type="number" name="realization_weight" class="form-control" value="{{ old('realization_weight') }}" required placeholder="KG" min="0" step="any">
                        </div>
                      </div>
                    </div>
                    <div class="row">
