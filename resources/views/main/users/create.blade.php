...
@section('breadcrumb')
  <div id="#breadcrumb">
    <ol class="breadcrumb">
      ...
      <li><a href="{{ route('users.create') }}" class="active">Tambah User</a></li>
    </ol>
  </div>
@endsection
    ...
    <div class="col-md-12">
      <div id="panel-info" class="panel panel-default">
        ...
        <div id="panel-body" class="panel-body">
          <div class="row">
            <div class="col-md-12">
              <form id="form" class="form" role="form" method="POST" action="{{ route('users.store') }}">
                {{ csrf_field() }}
                @if(isset($data))
                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      value="{{ old('username') }}" autocomplete="off" maxlength="6">
                    </div>
                  </div>
                </div>
                <div class="row">
