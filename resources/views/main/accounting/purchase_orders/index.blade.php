    ...
    function reload_datatable(){
      ...
      $('#table-dataTable').DataTable({
        ...
        columns: [
          ...
          { data: 'site.short_name', name: 'site.short_name'},
        ...
        columnDefs: [
          ...
          { title: "Site", className: "text-center w17-5", "targets": [ 1 ] },
          { title: "Supplier", className: "text-center w25", "targets": [ 2 ] },
          { title: "P.O Number", className: "text-center w17-5", "targets": [ 3 ] },
          { title: "P.O Date", className: "text-center w17-5", "targets": [ 4 ] },
          { title: "Action", className: "text-center w17-5", "targets": [ 5 ] },
        ],
        dom: 'lBfrtip',
        buttons: [
          // EXCEL BUTTON
          {
            extend : 'excelHtml5',
            text : 'Send to Excel',
            title: 'purchase_orders_'+_fileName+'_'+getCurrentDateTime(),
            footer: true,
            exportOptions: {
              modifier: {
                  search: 'applied',
