...
@section('title', 'Summary Penerimaan Roll')
...
@section('breadcrumb')
  <div id="#breadcrumb">
    <ol class="breadcrumb">
      ...
      <li><a href="{{ route('accounting.rollreceivesummary.index') }}">Summary Penerimaan Roll</a></li>
    </ol>
  </div>
@endsection
    ...
    <div class="col-md-12">
      <div id="panel-info" class="panel panel-default">
        <div class="panel-heading">
          <h3 class="panel-title">Summary Penerimaan Roll</h3>
        </div>
                ...
                <table id="table-dataTable" class="table table-hover table-striped" width="100%">
                  <thead>
                    <tr>
                      ...
                      <th class="text-center">Paper Group</th>
  ...
  <script>
    ...
    function reload_datatable(){
      ...
      $('#table-dataTable').DataTable({
        ...
        searchable: false,
        ajax: {
          'url' : '{!! route('accounting.rollreceivesummary.submit') !!}',
          'type': 'POST',
          'data': {
            _token : '{{ csrf_token() }}',
            date_from : _dateFrom,
        ...
        buttons: [
          // EXCEL BUTTON
          {
            extend : 'excelHtml5',
            text : 'Send to Excel',
            title: 'summary_rollreceives_'+_fileName+'_'+getCurrentDateTime(),
            footer: true,
            exportOptions: {
              modifier: {
                  search: 'applied',
