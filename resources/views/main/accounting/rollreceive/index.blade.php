...
@section('breadcrumb')
  <div id="#breadcrumb">
    <ol class="breadcrumb">
      ...
      <li><a href="{{ route('accounting.rollreceive.index') }}">Penerimaan Roll</a></li>
    </ol>
  </div>
@endsection
  ...
  <script>
    ...
    function reload_datatable(){
      ...
      $('#table-dataTable').DataTable({
        ...
        pageLength: 10,
        ajax: {
          'url' : '{!! route('accounting.rollreceive.submit') !!}',
          'type': 'POST',
        ...
        buttons: [
          // EXCEL BUTTON
          {
            extend : 'excelHtml5',
            text : 'Send to Excel',
            title: 'rollreceives_'+_fileName+'#'+getCurrentDateTime(),
            footer: true,
            exportOptions: {
              modifier: {
                  search: 'applied',
